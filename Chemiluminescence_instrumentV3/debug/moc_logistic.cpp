...
#include "../standardBightWidget/fourParameterLogistic/logistic.h"
...
const QMetaObject Logistic::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Logistic.data,
      qt_meta_data_Logistic,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Logistic::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Logistic.stringdata0))
        return static_cast<void*>(const_cast< Logistic*>(this));
