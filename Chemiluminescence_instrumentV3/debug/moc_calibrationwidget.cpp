...
QT_MOC_LITERAL(1, 18, 12), // "changeWindow"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 3), // "num"
QT_MOC_LITERAL(4, 36, 23), // "calibration_cmdSignSlot"
QT_MOC_LITERAL(5, 60, 3), // "str"
QT_MOC_LITERAL(6, 64, 19) // "quality_cmdSignSlot"

    },
    "calibrationWidget\0changeWindow\0\0num\0"
    "calibration_cmdSignSlot\0str\0"
    "quality_cmdSignSlot"
};
...
void calibrationWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changeWindow((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->calibration_cmdSignSlot((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->quality_cmdSignSlot((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
