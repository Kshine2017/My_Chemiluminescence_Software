#ifndef ORDINARYUSERMANAGEMENT_H
#define ORDINARYUSERMANAGEMENT_H
...
class OrdinaryUserManagement : public QWidget
{
    Q_OBJECT
public:
    explicit OrdinaryUserManagement(QWidget *parent = 0);
...
#endif // ORDINARYUSERMANAGEMENT_H
