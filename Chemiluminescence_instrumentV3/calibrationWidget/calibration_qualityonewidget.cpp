#include "calibration_qualityonewidget.h"
...
calibration_qualityOneWidget::calibration_qualityOneWidget(QWidget *parent) : QWidget(parent)
{
 ...
 * @brief 标题头初始化
 */
void calibration_qualityOneWidget::titleInit()
{
    ...
    titleTextLab->setText(tr("质控品结果显示"));
    ...
    titleTextLab->setGeometry(63,13,150,40);
    questionBtn = new QPushButton(this); //问号按钮
 ...
 * @brief 按钮初始化
 */
void calibration_qualityOneWidget::BtnInit()
{
 ...
 * @brief 选择初始化
 */
void calibration_qualityOneWidget::checkWidgetInit()
{
 ...
 * @brief 视图初始化
 */
void calibration_qualityOneWidget::tableviewInit()
{
 ...
 * @brief 曲线显示初始化
 */
void calibration_qualityOneWidget::displayWindowInit()
{
 ...
 * @brief 信号绑定函数初始化
 */
void calibration_qualityOneWidget::connectInit()
{
...
bool calibration_qualityOneWidget::insert_into_table_calibration_info(
        ...
        char DEL_FLAG)
{
    ...
    query.exec("insert into quality_control_info values (?,?,?,?,?,?,?,?,?,?,"
                                                        "?,?,?,?,?,?,?);");                                                        //ID 0
    ...
    bool ret = query.exec();
   //------------------------------------------------------------------
    if(!ret)qDebug()<<"质控品---新增---sql语句失败！"<<query.lastError();
    else qDebug()<<"质控品---新增---sql执行成功";
    return ret;


}

void calibration_qualityOneWidget::disPlayBtnSlot()
{
    QStringList list_name;      //项目名列表
...
//    QString name = "1111";
    ...
    //根据所传入的参数绘画曲线
    displayCruve->paint_cruve(name,x,y,2);

}

void calibration_qualityOneWidget::printBtnSlot()
{
    //1、创建打印机---------------------------------------------------------------
    QPrinter printer;
    //2、创建打印对话框
   ...
   // printer.setOrientation(QPrinter::Landscape);
    ...
    if (printDlg.exec()) //根据打印对话框的返回值
    {
        ...
        int border_left =10;
        //======================上下相邻参考，左右边界参考=====================================
        int BigTitle_leftX=border_left+120;
        int BigTitle_leftY=border_up+20;
        QString tem_TableName="铂纳科技化学发光上位机测试表格";
        //标题下方内容------科室 采样日期 操作人员 备注------
        int Info_X =border_left+ 30;
        int Info_Y = BigTitle_leftY + 40;
        int distance_X=150;
        QString Department="骨科";
        QString Operator="黄飞鸿";
        QString Date="2018-12-13";
        QString Remarks="无";
        //线框
        ...
        int column_distance=160;
        char column[5][30]={"组别","项目名称","标称浓度","测量浓度","单位"};

        //----------------------------------------------
        int group_number=1;
        int group_distanceY = 100;
       ...
       //组别
       painter.drawText(QRect(Text_X+column_distance*0+column_width_add[0],Text_Y+group_number*group_distanceY-group_distanceY/2-word_Height/2,200,100),"第一组",QTextOption());
       //项目名称
       painter.drawText(QRect(Text_X+column_distance*1+column_width_add[1],Text_Y+group_number*group_distanceY-group_distanceY/2-word_Height/2,200,100),"PCT",QTextOption());
       //标称浓度
       painter.drawText(QRect(Text_X+column_distance*2+column_width_add[2],Text_Y+group_number*group_distanceY-group_distanceY/4-word_Height/2,200,100),"0.0001",QTextOption());
       painter.drawText(QRect(Text_X+column_distance*2+column_width_add[2],Text_Y+group_number*group_distanceY-group_distanceY*3/4-word_Height/2,200,100),"0.0002",QTextOption());
       //测量浓度
       painter.drawText(QRect(Text_X+column_distance*3+column_width_add[3],Text_Y+group_number*group_distanceY-group_distanceY/4-word_Height/2,200,100),"0.9999",QTextOption());
       painter.drawText(QRect(Text_X+column_distance*3+column_width_add[3],Text_Y+group_number*group_distanceY-group_distanceY*3/4-word_Height/2,200,100),"0.9999",QTextOption());
       ...
       painter.drawLine(Line_X,Text_Y+(group_number)*group_distanceY,Line_X+line_length,Text_Y+(group_number)*group_distanceY);
       //组别
       painter.drawText(QRect(Text_X+column_distance*0+column_width_add[0],Text_Y+group_number*group_distanceY-group_distanceY/2-word_Height/2,200,100),"第二组",QTextOption());
       //项目名称
       painter.drawText(QRect(Text_X+column_distance*1+column_width_add[1],Text_Y+group_number*group_distanceY-group_distanceY/2-word_Height/2,200,100),"PRL",QTextOption());
       //标称浓度
       painter.drawText(QRect(Text_X+column_distance*2+column_width_add[2],Text_Y+group_number*group_distanceY-group_distanceY/4-word_Height/2,200,100),"0.0001",QTextOption());
       painter.drawText(QRect(Text_X+column_distance*2+column_width_add[2],Text_Y+group_number*group_distanceY-group_distanceY*3/4-word_Height/2,200,100),"0.0002",QTextOption());
       //测量浓度
       ...
       group_number=3;
       painter.drawLine(Line_X,Text_Y+(group_number)*group_distanceY,Line_X+line_length,Text_Y+(group_number)*group_distanceY);
       painter.drawText(QRect(Text_X+column_distance*0+column_width_add[0],Text_Y+group_number*group_distanceY-group_distanceY/2-word_Height/2,200,100),"第三组",QTextOption());
       //项目名称
       painter.drawText(QRect(Text_X+column_distance*1+column_width_add[1],Text_Y+group_number*group_distanceY-group_distanceY/2-word_Height/2,200,100),"CEA",QTextOption());
       //标称浓度
       painter.drawText(QRect(Text_X+column_distance*2+column_width_add[2],Text_Y+group_number*group_distanceY-group_distanceY/4-word_Height/2,200,100),"0.0001",QTextOption());
       painter.drawText(QRect(Text_X+column_distance*2+column_width_add[2],Text_Y+group_number*group_distanceY-group_distanceY*3/4-word_Height/2,200,100),"0.0002",QTextOption());
       //测量浓度
       ...
       group_number=4;
       painter.drawLine(Line_X,Text_Y+(group_number)*group_distanceY,Line_X+line_length,Text_Y+(group_number)*group_distanceY);
       painter.drawText(QRect(Text_X+column_distance*0+column_width_add[0],Text_Y+group_number*group_distanceY-group_distanceY/2-word_Height/2,200,100),"第四组",QTextOption());
       //项目名称
       painter.drawText(QRect(Text_X+column_distance*1+column_width_add[1],Text_Y+group_number*group_distanceY-group_distanceY/2-word_Height/2,200,100),"INS",QTextOption());
       //标称浓度
       painter.drawText(QRect(Text_X+column_distance*2+column_width_add[2],Text_Y+group_number*group_distanceY-group_distanceY/4-word_Height/2,200,100),"0.0001",QTextOption());
       painter.drawText(QRect(Text_X+column_distance*2+column_width_add[2],Text_Y+group_number*group_distanceY-group_distanceY*3/4-word_Height/2,200,100),"0.0002",QTextOption());
       //测量浓度
       ...
       group_number=5;
       painter.drawLine(Line_X,Text_Y+(group_number)*group_distanceY,Line_X+line_length,Text_Y+(group_number)*group_distanceY);
       painter.drawText(QRect(Text_X+column_distance*0+column_width_add[0],Text_Y+group_number*group_distanceY-group_distanceY/2-word_Height/2,200,100),"第五组",QTextOption());
       //项目名称
       painter.drawText(QRect(Text_X+column_distance*1+column_width_add[1],Text_Y+group_number*group_distanceY-group_distanceY/2-word_Height/2,200,100),"SCC",QTextOption());
       //标称浓度
       painter.drawText(QRect(Text_X+column_distance*2+column_width_add[2],Text_Y+group_number*group_distanceY-group_distanceY/4-word_Height/2,200,100),"0.0001",QTextOption());
       painter.drawText(QRect(Text_X+column_distance*2+column_width_add[2],Text_Y+group_number*group_distanceY-group_distanceY*3/4-word_Height/2,200,100),"0.0002",QTextOption());
       //测量浓度
       ...
       group_number=6;
       painter.drawLine(Line_X,Text_Y+(group_number)*group_distanceY,Line_X+line_length,Text_Y+(group_number)*group_distanceY);
       painter.drawText(QRect(Text_X+column_distance*0+column_width_add[0],Text_Y+group_number*group_distanceY-group_distanceY/2-word_Height/2,200,100),"第六组",QTextOption());
       //项目名称
       painter.drawText(QRect(Text_X+column_distance*1+column_width_add[1],Text_Y+group_number*group_distanceY-group_distanceY/2-word_Height/2,140,100),"AFP",QTextOption());
       //标称浓度
       painter.drawText(QRect(Text_X+column_distance*2+column_width_add[2],Text_Y+group_number*group_distanceY-group_distanceY/4-word_Height/2,200,100),"0.0001",QTextOption());
       painter.drawText(QRect(Text_X+column_distance*2+column_width_add[2],Text_Y+group_number*group_distanceY-group_distanceY*3/4-word_Height/2,200,100),"0.0002",QTextOption());
       //测量浓度
...
void calibration_qualityOneWidget::saveBtnSLot()
{
    qDebug()<<"点击保存按钮";
    QString  CATEGORY="品类";
...
void calibration_qualityOneWidget::returnBtnSlot()
{
