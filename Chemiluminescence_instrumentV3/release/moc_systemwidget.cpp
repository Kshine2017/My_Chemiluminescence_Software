...
struct qt_meta_stringdata_systemWidget_t {
    QByteArrayData data[1];
    char stringdata0[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_systemWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_systemWidget_t qt_meta_stringdata_systemWidget = {
    {
QT_MOC_LITERAL(0, 0, 12) // "systemWidget"
...
const QMetaObject systemWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_systemWidget.data,
      qt_meta_data_systemWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *systemWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_systemWidget.stringdata0))
