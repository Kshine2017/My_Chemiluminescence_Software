...
QT_MOC_LITERAL(1, 13, 16), // "checkStausChange"
QT_MOC_LITERAL(2, 30, 0) // ""

    },
    "MyHeaderView\0checkStausChange\0"
};
...
void MyHeaderView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->checkStausChange((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (MyHeaderView::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyHeaderView::checkStausChange)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyHeaderView::checkStausChange(bool _t1)
{
