...
const QMetaObject FaultDiagnosis::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FaultDiagnosis.data,
      qt_meta_data_FaultDiagnosis,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FaultDiagnosis::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FaultDiagnosis.stringdata0))
        return static_cast<void*>(const_cast< FaultDiagnosis*>(this));
